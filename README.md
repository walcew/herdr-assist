...
from the bridge — put your URLs in `~/.config/herdr-assist/avatar_repos` and the plugin
pushes them on every connection. Duplicate ids keep the first one seen, and the default
