 ...
 * calor), Sessões (lista de agentes), Dash (uso de limites dos provedores) e
 * Configurações. Sobrepostas: detalhe com terminal e teclado. Atualiza via
 * lv_timer observando herdr_model_generation(). Chamar com o mutex da LVGL
 * tomado (bsp_display_lock).
 *
