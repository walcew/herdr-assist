 ...
 * Size: 44 px
 * Bpp: 4
 * Opts: --size 44 --bpp 4 --format lvgl --no-compress --font scripts/.fontcache/Montserrat-Medium.ttf --range 0x30-0x3A --range 0x41-0x46 -o src/lv_font_ui_clock_44.c
 ******************************************************************************/
...
#ifndef LV_FONT_UI_CLOCK_44
#define LV_FONT_UI_CLOCK_44 1
#endif

#if LV_FONT_UI_CLOCK_44
...
static const lv_font_fmt_txt_glyph_dsc_t glyph_dsc[] = {
    ...
    {.bitmap_index = 0, .adv_w = 470, .box_w = 26, .box_h = 31, .ofs_x = 2, .ofs_y = 0},
    {.bitmap_index = 403, .adv_w = 260, .box_w = 12, .box_h = 31, .ofs_x = 0, .ofs_y = 0},
    {.bitmap_index = 589, .adv_w = 404, .box_w = 24, .box_h = 31, .ofs_x = 0, .ofs_y = 0},
    {.bitmap_index = 961, .adv_w = 403, .box_w = 24, .box_h = 31, .ofs_x = 0, .ofs_y = 0},
    {.bitmap_index = 1333, .adv_w = 471, .box_w = 28, .box_h = 31, .ofs_x = 1, .ofs_y = 0},
    {.bitmap_index = 1767, .adv_w = 404, .box_w = 24, .box_h = 31, .ofs_x = 0, .ofs_y = 0},
    {.bitmap_index = 2139, .adv_w = 434, .box_w = 24, .box_h = 31, .ofs_x = 2, .ofs_y = 0},
    {.bitmap_index = 2511, .adv_w = 421, .box_w = 24, .box_h = 31, .ofs_x = 1, .ofs_y = 0},
    {.bitmap_index = 2883, .adv_w = 453, .box_w = 26, .box_h = 31, .ofs_x = 1, .ofs_y = 0},
    {.bitmap_index = 3286, .adv_w = 434, .box_w = 25, .box_h = 31, .ofs_x = 1, .ofs_y = 0},
    {.bitmap_index = 3674, .adv_w = 160, .box_w = 6, .box_h = 24, .ofs_x = 2, .ofs_y = 0},
    {.bitmap_index = 3746, .adv_w = 515, .box_w = 34, .box_h = 31, .ofs_x = -1, .ofs_y = 0},
    {.bitmap_index = 4273, .adv_w = 533, .box_w = 28, .box_h = 31, .ofs_x = 4, .ofs_y = 0},
    {.bitmap_index = 4707, .adv_w = 509, .box_w = 29, .box_h = 31, .ofs_x = 2, .ofs_y = 0},
    {.bitmap_index = 5157, .adv_w = 582, .box_w = 31, .box_h = 31, .ofs_x = 4, .ofs_y = 0},
    {.bitmap_index = 5638, .adv_w = 472, .box_w = 23, .box_h = 31, .ofs_x = 4, .ofs_y = 0},
    {.bitmap_index = 5995, .adv_w = 447, .box_w = 23, .box_h = 31, .ofs_x = 4, .ofs_y = 0}
};
...
static const lv_font_fmt_txt_cmap_t cmaps[] =
{
    ...
    {
        .range_start = 65, .range_length = 6, .glyph_id_start = 12,
        .unicode_list = NULL, .glyph_id_ofs_list = NULL, .list_length = 0, .type = LV_FONT_FMT_TXT_CMAP_FORMAT0_TINY
    }
};
...
#if LV_VERSION_CHECK(8, 0, 0)
const lv_font_t lv_font_ui_clock_44 = {
#else
lv_font_t lv_font_ui_clock_44 = {
#endif
